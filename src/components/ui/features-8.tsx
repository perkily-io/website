...
export function Features() {
    return (
        <section className="bg-black pt-8 pb-16 md:pt-12 md:pb-32">
            <div className="mx-auto max-w-3xl lg:max-w-5xl px-6">
                {/* Heading Section */}
                <div className="mb-12 md:mb-16 text-center">
                    <h1 className="text-3xl md:text-4xl font-semibold text-white mb-3 tracking-tight">
                        Precision Billing. <br />
                        <span className="text-4xl md:text-[5rem] lg:text-[6rem] font-bold leading-none">Zero Leaks.</span>
                    </h1>
                ...
                <div className="relative">
                    <div className="relative z-10 grid grid-cols-6 gap-3">
                        <Card className="relative col-span-full flex overflow-hidden lg:col-span-2 bg-black/50 border border-white/10 backdrop-blur-xl">
                        ...
                        <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2 bg-black/50 border border-white/10 backdrop-blur-xl">
                            <CardContent className="pt-6">
                                <div className="relative mx-auto flex items-center justify-center h-32">
                                    <div className="text-4xl font-bold text-gray-400 tracking-wider">HIPAA</div>
                                </div>
                                <div className="relative z-10 mt-6 space-y-2 text-center">
                                    <h2 className="text-lg font-medium transition text-white">HIPAA Compliant</h2>
                                    <p className="text-white/70">Enterprise-grade security with end-to-end encryption. Your patient data is protected with industry-leading compliance standards.</p>
                                </div>
                            </CardContent>
                        </Card>
                        <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2 bg-black/50 border border-white/10 backdrop-blur-xl">
                            <CardContent className="pt-6">
                                ...
                                <div className="relative z-10 mt-14 space-y-2 text-center">
                                    <h2 className="text-lg font-medium transition text-white">Real-Time Claims</h2>
                                    <p className="text-white/70">Instant claim generation and submission. From clinical encounter to claim approval in seconds, not days.</p>
                                </div>
                            </CardContent>
                        </Card>
                        <Card className="relative col-span-full overflow-hidden lg:col-span-3 bg-black/50 border border-white/10 backdrop-blur-xl">
                            <CardContent className="grid pt-6 sm:grid-cols-2 gap-6">
                                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                    <div className="space-y-2">
                                        <h2 className="text-lg font-medium transition text-white">Voice to Notes</h2>
                                        <p className="text-white/70">Speak naturally during patient visits. ClinicalOS converts your voice to structured SOAP notes instantly.</p>
                                    </div>
                                </div>
                        ...
                        <Card className="relative col-span-full overflow-hidden lg:col-span-3 bg-black/50 border border-white/10 backdrop-blur-xl">
                            <CardContent className="grid h-full pt-6 sm:grid-cols-2">
                                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                    <div className="space-y-2">
                                        <h2 className="text-lg font-medium transition text-white">Patient-Centered</h2>
                                        <p className="text-white/70">Complete patient management with integrated scheduling, records, and communication all in one platform.</p>
                                    </div>
                                </div>
                                <div className="before:bg-(--color-border) relative mt-6 before:absolute before:inset-0 before:mx-auto before:w-px sm:-my-6 sm:-mr-6">
                                    <div className="relative flex h-full flex-col justify-center space-y-6 py-6">
                                        <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                                            <span className="block h-fit rounded border px-2 py-1 text-xs shadow-sm">Dr. Sarah Chen</span>
                                            <div className="ring-background size-7 ring-4">
                                                <img className="size-full rounded-full" src="https://images.unsplash.com/photo-1559839734-2b71ea197ec2?w=100&h=100&fit=crop" alt="Dr. Sarah Chen" />
                                            </div>
                                        </div>
                                        <div className="relative ml-[calc(50%-1rem)] flex items-center gap-2">
                                            <div className="ring-background size-8 ring-4">
                                                <img className="size-full rounded-full" src="https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?w=100&h=100&fit=crop" alt="Dr. Michael Park" />
                                            </div>
                                            <span className="block h-fit rounded border px-2 py-1 text-xs shadow-sm">Dr. Michael Park</span>
                                        </div>
                                        <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                                            <span className="block h-fit rounded border px-2 py-1 text-xs shadow-sm">Dr. Emily Rodriguez</span>
                                            <div className="ring-background size-7 ring-4">
                                                <img className="size-full rounded-full" src="https://images.unsplash.com/photo-1594824476966-48c8b964273f?w=100&h=100&fit=crop" alt="Dr. Emily Rodriguez" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
